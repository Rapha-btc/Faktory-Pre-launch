;; ;; f2a316292e682b5bf8ff7716054bb0355c2d602ed3de73a517fe10d751b9e2d0
;; ;; nothing Powered By Faktory.fun v1.0 
...
(define-fungible-token NOTHING MAX)
(define-constant MAX u1000000000000000)
;; (define-data-var contract-owner principal 'SP2XCME6ED8RERGR9R7YDZW7CA6G3F113Y8JMVA46.nothing-token-owner)
;; (define-data-var token-uri (optional (string-utf8 256)) (some u"https://bncytzyfafclmdxrwpgq.supabase.co/storage/v1/object/public/tokens/5f97916c-f59f-4e0d-a8a3-f62f60489152.json"))

;; SIP-10 Functions
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       (asserts! (is-eq tx-sender sender) (err ERR-NOT-AUTHORIZED))
       (match (ft-transfer? NOTHING amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
...
;;   (ok (ft-get-balance NOTHING account))
;; )
...
;;         name: "Nothing DAO",
;;         symbol: "NOTHING",
;;         token-uri: u"https://bncytzyfafclmdxrwpgq.supabase.co/storage/v1/object/public/tokens/5f97916c-f59f-4e0d-a8a3-f62f60489152.json", 
...
;; intialize pre-launch vesting contract
;; (contract-call? .simple-pre-launch initialize-token-distribution)
